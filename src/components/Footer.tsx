...
import { footerData, siteConfig } from "@/data/portfolio";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          <div className="text-center md:text-left">
            ...
            <p className="mt-1 text-sm text-zinc-600">{footerData.tagline}</p>
          </div>
        ...
        <div className="mt-10 border-t border-zinc-800/50 pt-6 text-center">
          <p className="text-xs text-zinc-600">{footerData.copyright}</p>
        </div>
      </div>
    </footer>
  );
